...
class Perceiver(nn.Module):
    def __init__(
            ...
            *,
            num_freq_bands=6,
            depth=2,  # Depth 2 worked best in my case, this is like how much layers in CNNs, can try more depth
            max_freq=10.,
            input_channels=512,
            input_axis=1,
            num_latents=256,
            ...
            # you can share the weights from the first layer for the next ones, didnt help in my case
